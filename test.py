...
'Alt-Used': 'www.vikacg.com',
'Connection': 'keep-alive',
'Referer': 'https://www.vikacg.com/?variant=zh-cn',
...
'Alt-Used': 'www.vikacg.com',
'Connection': 'keep-alive',
# 'Referer': 'https://www.vikacg.com/user/+id',
'Sec-Fetch-Dest': 'empty',
'Sec-Fetch-Mode': 'cors',
'Sec-Fetch-Site': 'same-origin',
'TE': 'trailers'
...
url3 = "https://www.vikacg.com/wp-json/b2/v1/userMission"
...
while (num<2):
    ...
    header4 = {
        ...
        'sec-fetch-mode': 'cors',
        'sec-fetch-dest': 'empty',
        'referer': 'https://www.vikacg.com/user/' + str(id),
        # accept-encoding: gzip, deflate
        'accept-language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7'
    }
    data4 = {
    ...
    url4 = "https://www.vikacg.com/wp-json/b2/v1/AuthorFollow"
